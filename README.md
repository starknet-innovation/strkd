...
on-device that **verified on-chain**. Next up: **bramble convergence** — see
[`docs/project/bramble-convergence.md`](./docs/project/bramble-convergence.md).
Privacy (`strk20*`) is **parked**, not pending.
